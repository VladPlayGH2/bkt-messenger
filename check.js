...
let peer=null, localCallStream=null, incomingCall=null, callType="audio", pendingIceCandidates=[];
...
async function startCall(type){
  ...
  try{
    ...
    if(type==="video"){
      ...
      $("remoteVideo").srcObject=localCallStream;
    }else{
...
async function acceptIncomingCall(){
  ...
  try{
    ...
    for(const c of pendingIceCandidates){try{await peer.addIceCandidate(c)}catch(e){}}
    pendingIceCandidates=[];
...
function endCall(notify=true){
  ...
  peer=null;localCallStream=null;incomingCall=null;pendingIceCandidates=[];
